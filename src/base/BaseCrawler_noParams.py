...
from src.base.BaseConfig_noParams import BaseConfig_noParams
...
class BaseCrawler_noParams:
    ...
    CRAWLER_NR = 0
    CONFIG_CLASS = BaseConfig_noParams
    ...
    def name(self, val):
        if val is None:
            if self.flag is not None:
                self._name = f'Crawler_{BaseCrawler_noParams.CRAWLER_NR}/{self.flag}'
            else:
                self._name = f'Crawler_{BaseCrawler_noParams.CRAWLER_NR}'
            BaseCrawler_noParams.CRAWLER_NR += 1
